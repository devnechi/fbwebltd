...
<head>
    ...
    <title>{{ config('app.name', 'FBC Admin') }}</title>
...
{{--
    ...
    <style>
        ...
        *::after {
        ...
        .bg-usernav {
            background-color: #9ee6b1 !important;
    ...
    */
    ...
    ----------------------------------------------------- */
        ...
        #sidebar ul.components {
            padding: 20px 0;
            border-bottom: 1px solid #0f323c;
        }
    ...
    .navbar {
     margin-bottom: 2px;
        ...
        .card [data-background-color="orange"] {
            background: linear-gradient(60deg, #0f323c, #0f323c);
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                <div class="sidebar-header">
                    <h3 class="dash-header"> FBC admin Dashboard</h3>
                </div>

                <ul class="list-unstyled components">
                    <p style="font-size:800;">Navigation</p>
                    <li><a href="{{ route('main-admin') }}">Dashboard</a></li>
                    <li><a href="{{ route('manage-projects') }}">Company Projects</a></li>
                    <li><a href="{{ route('manage-users') }}">User Management</a></li>


                    <!-- <li><a href="dlab_create_project.php">Create A new project</a></li> -->
                    <li><a href="{{ route('manage-financial-activities') }}">Finance Management</a></li>
